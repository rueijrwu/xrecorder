...
def run_cli():
    ...
    parser.add_argument("--width", type=int, default=4096, help="Camera width")
    parser.add_argument("--height", type=int, default=992, help="Camera height")
    ...
    parser.add_argument("--offset-y", type=int, default=0, help="ROI Y offset")
    ...
    print(f"Initializing XIMEA High-Speed Capture App (Python)...")
    ...
    print(f"Camera: {cam_cfg.width}x{cam_cfg.height} @ {args.save_fps}Hz, Exposure: {cam_cfg.exposure_us}us, Gain: {cam_cfg.gain_db}dB")
    ...
    try:
        while manager.is_running():
            ...
            # Pad with spaces to overwrite any previous longer string
